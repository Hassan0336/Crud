...
<!--===============================================================================================-->
	...
	<script src="https://kit.fontawesome.com/ae6661ff11.js" crossorigin="anonymous"></script>
<!--===============================================================================================-->
</head>
<body>
		...
		<div class="container-login100" ">
			<div class="wrap-login100">
				<form class="login100-form " action="Login.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Your Number">
						<input class="input100" type="number" name="pass" placeholder="Number">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
